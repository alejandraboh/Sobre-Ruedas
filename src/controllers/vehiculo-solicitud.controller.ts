...
export class VehiculoSolicitudController {
  ...
  async find(
    ...
    return this.vehiculoRepository.Vehiculo_Solicitud(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehiculoRepository.Vehiculo_Solicitud(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.vehiculoRepository.Vehiculo_Solicitud(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.vehiculoRepository.Vehiculo_Solicitud(id).delete(where);
  }
}
