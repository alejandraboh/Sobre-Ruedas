...
export class DepartamentoCiudadController {
  ...
  async find(
    ...
    return this.departamentoRepository.Departamento_Ciudad(id).find(filter);
  }
  ...
  async create(
    ...
    return this.departamentoRepository.Departamento_Ciudad(id).create(ciudad);
  }
  ...
  async patch(
    ...
    return this.departamentoRepository.Departamento_Ciudad(id).patch(ciudad, where);
  }
  ...
  async delete(
    ...
    return this.departamentoRepository.Departamento_Ciudad(id).delete(where);
  }
}
