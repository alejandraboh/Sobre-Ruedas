...
export class TipoVehiculoVehiculoController {
  ...
  async find(
    ...
    return this.tipoVehiculoRepository.Vehiculo_TipoVeh(id).find(filter);
  }
  ...
  async create(
    ...
    return this.tipoVehiculoRepository.Vehiculo_TipoVeh(id).create(vehiculo);
  }
  ...
  async patch(
    ...
    return this.tipoVehiculoRepository.Vehiculo_TipoVeh(id).patch(vehiculo, where);
  }
  ...
  async delete(
    ...
    return this.tipoVehiculoRepository.Vehiculo_TipoVeh(id).delete(where);
  }
}
