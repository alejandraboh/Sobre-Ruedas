...
export class AsesorVehiculoController {
  ...
  async find(
    ...
    return this.asesorRepository.Asesor_Vehiculo(id).find(filter);
  }
  ...
  async create(
    ...
    return this.asesorRepository.Asesor_Vehiculo(id).create(vehiculo);
  }
  ...
  async patch(
    ...
    return this.asesorRepository.Asesor_Vehiculo(id).patch(vehiculo, where);
  }
  ...
  async delete(
    ...
    return this.asesorRepository.Asesor_Vehiculo(id).delete(where);
  }
}
