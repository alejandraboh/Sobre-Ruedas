...
export class ClienteSolicitudController {
  ...
  async find(
    ...
    return this.clienteRepository.Cliente_Solicitud(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.Cliente_Solicitud(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.Cliente_Solicitud(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.Cliente_Solicitud(id).delete(where);
  }
}
