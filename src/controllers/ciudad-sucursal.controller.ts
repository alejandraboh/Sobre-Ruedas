...
export class CiudadSucursalController {
  ...
  async find(
    ...
    return this.ciudadRepository.Sucursal_Ciudad(id).find(filter);
  }
  ...
  async create(
    ...
    return this.ciudadRepository.Sucursal_Ciudad(id).create(sucursal);
  }
  ...
  async patch(
    ...
    return this.ciudadRepository.Sucursal_Ciudad(id).patch(sucursal, where);
  }
  ...
  async delete(
    ...
    return this.ciudadRepository.Sucursal_Ciudad(id).delete(where);
  }
}
