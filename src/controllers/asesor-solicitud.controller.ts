...
export class AsesorSolicitudController {
  ...
  async find(
    ...
    return this.asesorRepository.Asesor_Solicitud(id).find(filter);
  }
  ...
  async create(
    ...
    return this.asesorRepository.Asesor_Solicitud(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.asesorRepository.Asesor_Solicitud(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.asesorRepository.Asesor_Solicitud(id).delete(where);
  }
}
